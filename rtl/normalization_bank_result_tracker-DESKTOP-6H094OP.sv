module normalization_bank_result_tracker #(
    ...
    logic[ENTRIES-1:0]valid_q,complete_q;
    // Unpacked entries keep variable entry indices legal in Icarus and Yosys.
    logic[TAG_WIDTH-1:0]tag_q[0:ENTRIES-1];
    ...
    always @* begin
      ...
      for(integer e=0;e<ENTRIES;e++) received_d[e]=received_q[e];
