...
export DESIGN_NICKNAME = b1_logic_die_baseline
...
export VERILOG_TOP_PARAMS = CHANNELS 1 BANKS 1 PIM_BLOCKS 1 PCUS 1 \
  ROWS 1 COLS 1 DATA_WIDTH 16 CRF_DEPTH 2 WEIGHT_BUFFER_BYTES 16 \
  ENABLE_LOGIC_DIE_PCU 1 ENABLE_NORMALIZATION_ENGINE 0
...
export SDC_FILE = $(STOB_REPO_ROOT)/b1_logic_die_experiment/constraint.sdc
