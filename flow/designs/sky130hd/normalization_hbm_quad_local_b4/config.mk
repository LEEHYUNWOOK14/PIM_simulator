...
export DESIGN_NICKNAME = normalization_hbm_quad_local_b4
# B4 is a placement-only routability ECO.  The functional mapped netlist and
# design name remain identical to B2; artifacts and policy are variant-local.
...
export VERILOG_FILES = $(STOB_REPO_ROOT)/reports/groot_normalization/quad_local_b4/logic_die_normalization_hbm_quad_local_b2_top_sky130.v
...
# B4 restores B2's stable one-iteration CuGR policy.  Placement is the only
# changed physical variable, and global route is invoked exactly once.
