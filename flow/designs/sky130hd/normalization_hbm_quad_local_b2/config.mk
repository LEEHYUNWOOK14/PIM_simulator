...
export DESIGN_NICKNAME = normalization_hbm_quad_local_b2
...
export VERILOG_FILES = $(STOB_REPO_ROOT)/reports/groot_normalization/quad_local_b2/logic_die_normalization_hbm_quad_local_b2_top_sky130.v
...
# Match the frozen A/B die envelope and the capacity contract used by B.
