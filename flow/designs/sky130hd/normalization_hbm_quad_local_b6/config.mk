...
export DESIGN_NICKNAME = normalization_hbm_quad_local_b6
...
# B6 is a physical-only anchor-lock ECO.  This mapped netlist is byte-identical
# to the sealed B2/B5 netlist and is rechecked by B6 authorization.
