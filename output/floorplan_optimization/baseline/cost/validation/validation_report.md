...
|thermal burden monotonic across 4/8/12Hi|True|`[0.27632622713503696, 0.4465878418344032, 0.6559258926942797]`|
...
|seeded uncertainty reproducible|True|`[{'scenario': 'hbm2_4hi_1stack', 'p05': 1.4413874905241968, 'p50': 1.58295001864285, 'p95': 1.769086999690303, 'best_rank_probability': 0.0, 'no_feasible_probability': 0.0305, 'samples': 2000}, {'scenario': 'hbm2_8hi_1stack', 'p05': 1.0, 'p50': 1.0, 'p95': 1.0, 'best_rank_probability': 0.711, 'no_fe`|
|rank and no-feasible probabilities sum to one|True|`{'rank': [0.0, 0.711, 0.0, 0.111, 0.1475], 'no_feasible': 0.0305}`|
