...
puts "WBQ_B7_PHASE7_AUDIT_TOP [$block getName]"
puts "WBQ_B7_PHASE7_AUDIT_CLOCK_NET_COUNT $clock_net_count"
puts "WBQ_B7_PHASE7_AUDIT_SIGNAL_WIRE_COUNT $signal_wire_count"
puts "WBQ_B7_PHASE7_AUDIT_DESIGN_IS_ROUTED $fully_routed"
if {[$block getName] ne "logic_die_normalization_hbm_quad_local_b2_top"} {
  error "unexpected B7 Phase 7 top"
}
