...
puts "V2_ROUTE_STAGE global_route"
global_route \
  -guide_file $report_root/logic_die_normalization_hbm_top_v2.route_guide \
  -congestion_report_file $report_root/logic_die_normalization_hbm_top_v2.congestion.rpt \
