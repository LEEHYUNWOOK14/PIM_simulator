...
puts "WBQ_B3_PHASE7_AUDIT_TOP [$block getName]"
puts "WBQ_B3_PHASE7_AUDIT_CLOCK_NET_COUNT $clock_net_count"
puts "WBQ_B3_PHASE7_AUDIT_SIGNAL_WIRE_COUNT $signal_wire_count"
puts "WBQ_B3_PHASE7_AUDIT_DESIGN_IS_ROUTED $fully_routed"
if {[$block getName] ne "logic_die_normalization_hbm_quad_local_b2_top"} {
  error "unexpected B3 Phase 7 top"
}
if {$clock_net_count < 1 || $signal_wire_count < 1 || !$fully_routed} {
  error "B3 Phase 7 detailed-route audit failed"
}
puts "WBQ_B3_PHASE7_DETAILED_ROUTE_AUDIT PASS"
