...
puts "WBQ_B3_PHASE6_ROUTE_AUDIT_TOP [$block getName]"
puts "WBQ_B3_PHASE6_ROUTE_AUDIT_CLOCK_NET_COUNT $clock_net_count"
puts "WBQ_B3_PHASE6_ROUTE_AUDIT_HAS_GLOBAL_ROUTES $has_routes"
puts "WBQ_B3_PHASE6_ROUTE_AUDIT_VIOLATIONS {$violations}"
if {[$block getName] ne "logic_die_normalization_hbm_quad_local_b2_top"} {
  error "unexpected B3 Phase 6 post-CTS top"
}
if {$clock_net_count < 1 || !$has_routes || $violations ne ""} {
  error "B3 Phase 6 post-CTS route audit failed"
}
puts "WBQ_B3_PHASE6_POST_CTS_ROUTE_AUDIT PASS"
