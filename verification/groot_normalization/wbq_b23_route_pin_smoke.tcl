foreach name {WBQ_B23_SMOKE_INPUT_ODB WBQ_B23_SMOKE_INPUT_SDC WBQ_B23_SMOKE_OUTPUT_ODB WBQ_PLATFORM_ROOT} {
...
read_db $::env(WBQ_B23_SMOKE_INPUT_ODB)
read_sdc $::env(WBQ_B23_SMOKE_INPUT_SDC)
...
set x0 1750.0
set y0 750.0
if {[llength $bump_terms] != 565} { error "unexpected B23 bump count [llength $bump_terms]" }
set index 0
...
write_db $::env(WBQ_B23_SMOKE_OUTPUT_ODB)
puts "WBQ_B23_SMOKE_INPUT_REOPEN_AND_CHECKPOINT PASS bump_terms=[llength $bump_terms] columns=$columns"
