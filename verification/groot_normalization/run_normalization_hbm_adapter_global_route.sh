...
config="$root/flow/designs/sky130hd/normalization_hbm_adapter_feasibility/config.mk"
cd "$flow"
...
result_dir="$flow/results/sky130hd/normalization_hbm_adapter_feasibility/base"
test -s "$result_dir/5_1_grt.odb"
echo "NORMALIZATION_HBM_ADAPTER_GLOBAL_ROUTE PASS odb=$result_dir/5_1_grt.odb"
