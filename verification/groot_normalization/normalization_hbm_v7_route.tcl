...
# Keep the successful V4 placement and boundary model fixed.  V7 isolates the
# effect of giving congestion-driven rip-up-and-reroute five iterations instead
# of one.
set bump_terms {}
...
puts "V7_BUMP_PIN_COUNT [llength $bump_terms]"

set_routing_layers -signal met1-met5 -clock met2-met5
puts "V7_ROUTE_STAGE global_route"
global_route \
  -guide_file $report_root/logic_die_normalization_hbm_top_v7.route_guide \
  -congestion_report_file $report_root/logic_die_normalization_hbm_top_v7.congestion.rpt \
