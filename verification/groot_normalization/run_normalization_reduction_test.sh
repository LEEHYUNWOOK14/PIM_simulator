...
python3 tools/generate_normalization_reduction_vectors.py
"${iv}" -B "${base}" -g2012 -s logic_normalization_reduction_engine_tb \
  -o /tmp/logic_normalization_reduction_engine_tb.out \
  ...
  verification/groot_normalization/logic_normalization_reduction_engine_tb.sv
"${vvp}" -M "${base}" /tmp/logic_normalization_reduction_engine_tb.out
