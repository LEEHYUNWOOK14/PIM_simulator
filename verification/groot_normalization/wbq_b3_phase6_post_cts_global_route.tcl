...
if {![string is integer -strict $iterations] || $iterations != 10} {
  error "B3 Phase 6 post-CTS congestion iterations must be 10"
}
...
puts "WBQ_B3_PHASE6_POST_CTS_BUMP_PIN_COUNT [llength $bump_terms]"
puts "WBQ_B3_PHASE6_POST_CTS_CUGR_ITERATIONS $iterations"
set_routing_layers -signal met1-met5 -clock met2-met5
global_route \
  -guide_file $output_root/b3_phase6_post_cts.route_guide \
  -congestion_report_file $output_root/b3_phase6_post_cts.congestion.rpt \
...
report_design_area
write_db $output_root/b3_phase6_post_cts_global_route.odb
write_sdc -no_timestamp $output_root/b3_phase6_post_cts_global_route.sdc
puts "WBQ_B3_PHASE6_POST_CTS_GLOBAL_ROUTE PASS"
