...
read_db $report_root/logic_die_normalization_hbm_top_v5_bank_legal.odb
read_sdc $report_root/logic_die_normalization_hbm_top_v5_bank_legal.sdc
source $platform_root/setRC.tcl

# Preserve the V4 physical boundary model so that placement locality is the
# only intended routing variable.
set bump_terms {}
...
puts "V5_BANK_ROUTE_BUMP_PIN_COUNT [llength $bump_terms]"

set_routing_layers -signal met1-met5 -clock met2-met5
puts "V5_BANK_ROUTE_STAGE global_route"
global_route \
  -guide_file $report_root/logic_die_normalization_hbm_top_v5_bank.route_guide \
  -congestion_report_file $report_root/logic_die_normalization_hbm_top_v5_bank.congestion.rpt \
