...
puts "V5_ROUTE_BUMP_PIN_COUNT [llength $bump_terms]"

set_routing_layers -signal met1-met5 -clock met2-met5
puts "V5_ROUTE_STAGE global_route"
global_route \
  -guide_file $report_root/logic_die_normalization_hbm_top_v5.route_guide \
  -congestion_report_file $report_root/logic_die_normalization_hbm_top_v5.congestion.rpt \
