foreach name {WBQ_B25_SMOKE_INPUT_ODB WBQ_B25_SMOKE_INPUT_SDC WBQ_B25_SMOKE_OUTPUT_ODB WBQ_PLATFORM_ROOT} {
...
read_db $::env(WBQ_B25_SMOKE_INPUT_ODB)
read_sdc $::env(WBQ_B25_SMOKE_INPUT_SDC)
...
write_db $::env(WBQ_B25_SMOKE_OUTPUT_ODB)
puts "WBQ_B25_SMOKE_INPUT_REOPEN_AND_CHECKPOINT PASS bump_terms=[llength $bump_terms] columns=$columns x0=$x0 y0=$y0"
